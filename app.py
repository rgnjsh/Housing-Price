...
model_file_path = 'LinearModel.pkl'

if os.path.exists(model_file_path) and os.path.isfile(model_file_path):
    with open(model_file_path, 'rb') as file:
        pipe = pickle.load(file)
else:
    print(f"Error: File '{model_file_path}' not found or not readable.")


data = pd.read_csv('C:\\Users\\pushp\\Desktop\\c++\\python\\cleaned_data.csv')
pipe = pickle.load(open(r'C:\Users\pushp\Desktop\c++\python\LinearModel.pkl', 'rb'))
